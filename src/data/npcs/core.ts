...
export const NPCS = [
  { id: "doyen_orme", name: "Doyen Orme", color: "roof", schedule: [{ start: 6, end: 22, zone: "place_puits", x: 112, y: 72 }], chatter: [
  ...
  { id: "mira", name: "Mira", color: "leaf", schedule: [{ start: 11, end: 19, zone: "place_puits", x: 192, y: 88 }, { start: 6, end: 11, zone: "lisiere_carrefour", x: 80, y: 80 }], chatter: [
  ...
  { id: "bram", name: "Bram", color: "stone", schedule: [{ start: 8, end: 20, zone: "hameau_nord", x: 96, y: 80 }], chatter: [
  ...
  { id: "nessa", name: "Nessa", color: "water", schedule: [{ start: 6, end: 20, zone: "quai_lac", x: 128, y: 128 }], chatter: [
  ...
  { id: "ryn", name: "Ryn", color: "sand", schedule: [{ start: 6, end: 22, zone: "hameau_sud", x: 96, y: 96 }], chatter: [
  ...
  { id: "tam", name: "Tam", color: "sand", schedule: [{ start: 6, end: 22, zone: "hameau_sud", x: 120, y: 96 }], chatter: [
  ...
  { id: "colporteur", name: "Le Colporteur", color: "roof", schedule: [{ start: 8, end: 20, zone: "lisiere_carrefour", x: 144, y: 144 }], chatter: [
  ...
  { id: "sylve", name: "Sylve", color: "leaf", schedule: [{ start: 6, end: 22, zone: "place_puits", x: 80, y: 144 }], chatter: [
    "…", "Sylve pointe vers le nord.", "Sylve dessine un cercle dans la poussière.", "Sylve vous tend une petite feuille."
  ]},
  { id: "gorm", name: "Gorm", color: "stone", schedule: [{ start: 0, end: 24, zone: "marches_ruines", x: 192, y: 80 }], chatter: [
    "VA-T'EN.", "Je n'ai rien à dire aux cartes.", "Pose la pomme et recule.", "Le canal n'a pas été bâti pour dormir."
  ]},
  { id: "iris", name: "Îris", color: "purple", schedule: [{ start: 0, end: 24, zone: "lisiere_carrefour", x: 48, y: 144 }], chatter: [
  ...
  { id: "fermier_b", name: "Béa", color: "sand", schedule: [{ start: 7, end: 18, zone: "marches_ruines", x: 88, y: 144 }], chatter: [
